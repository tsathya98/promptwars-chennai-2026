...
- **DO NOT BUILD**: User authentication (MSAL/OAuth), user accounts, database setup (Postgres/DynamoDB), settings screens, multi-tenancy, i18n, micro-frontends, or heavy testing suites.
- **MUST BUILD**:
